          ...
          <Dialog open={inviteDialogOpen} onOpenChange={setInviteDialogOpen}>
            <DialogContent className="max-w-2xl rounded-[2rem] border-2 border-primary/30 bg-white px-8 py-8 shadow-xl">
              ...
              <div className="space-y-6">
                ...
                {inviteError ? (
                  <p className="text-sm font-semibold text-destructive">{inviteError}</p>
                ) : null}
                <div className="asap-scroll [scrollbar-gutter:stable] max-h-50 space-y-3 overflow-y-auto pr-1">
                  {invitesLoading ? (
