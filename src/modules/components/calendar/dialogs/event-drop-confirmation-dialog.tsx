...
import {formatTime, getColorClass, getEventAccentStyles} from "@/modules/components/calendar/helpers";
        ...
        <AlertDialog open={open} onOpenChange={onOpenChange}>
            <AlertDialogContent>
                <AlertDialogHeader>
					...
					<span
						className={cn(getColorClass(event.color), "mx-1 py-0.5 px-1 rounded-md")}
						style={getEventAccentStyles(event, { text: true })}
					>
						{event.title}
					</span>
                        event from
