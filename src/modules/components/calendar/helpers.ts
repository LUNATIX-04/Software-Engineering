...
export const getEventAccentStyles = (
	event: IEvent,
	opts?: { background?: boolean; border?: boolean; text?: boolean },
	...
	if (opts?.text && event.accentTextColor) {
		style.color = event.accentTextColor;
	}
	return style;
};
