...
export default function RootLayout({
  ...
  return (
    ...
    >{`(function(){try{var key="asap:theme-preference";var theme=localStorage.getItem(key);var valid=["standard","light","dark","red","green","yellow"];var root=document.documentElement;var body=document.body;if(body)body.setAttribute("data-theme-init","pending");if(theme&&valid.indexOf(theme)!==-1){if(theme==="standard"){if(body)body.removeAttribute("data-theme");root.removeAttribute("data-theme");}else{if(body)body.setAttribute("data-theme",theme);root.setAttribute("data-theme",theme);}root.classList.toggle("dark",theme==="dark");if(body)body.removeAttribute("data-theme-init");}}catch(e){var b=document.body;if(b)b.removeAttribute("data-theme-init");}})();`}</Script>
      </head>
      <body
