อัพเดทพวก
- เพิ่มระบบ Notification (ยังไม่ realtime แต่ใกล้เคียง เพราะต้อง refresh หน้า)
- แก้บัคเล็กน้อยของ Task Submission
- เพิ่มความลื่นไหลของ UI ASAP
- optimize backend ของ ASAP ให้ลื่นไหลมากขึ้น
- filter ใน calendar สามารถใช้งาน
- ลบ Theme Dark, Light ออก แทนด้วย Yellow, Green แทน เพราะยังมีบัคเรื่อง Theme อยู่จึงไม่สามารถนำมาใส่ใน ver.1.2.1 นี่ได้
...
7. ย้ายไป Branch Latest-Release-Version- ก่อนเพราะอันนี้คือล่าสุด
